...
- [x] Construir o join da tabela payments e realizar os filtros necessários estudados para a view final que será utilizada.
- [x] Criação das views das tabelas fato e dimensão carregadas no Power BI.

Data Viz:
- [x] Carregamento no Power BI e criação do relacionamento entre tabelas.
- [ ] Definição da identidade visual e criação das primeiras métricas e visualizações
